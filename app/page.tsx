...
import { resolveFooterHref } from "@/components/layout/SiteFooter";
...
function FooterLabel({ label, className }: { label: string; className: string }) {
  const href = resolveFooterHref(label);
  if (!href) return <div className={className}>{label}</div>;
    ...
    <div className={styles.page}>
      ...
      <footer className={styles.footer}>
          ...
          <div>
            ...
            <div className={styles.footerLinks}>
              {settings.landing.footer.productLinks.map((item) => (
                <FooterLabel key={item} label={item} className={styles.footerLink} />
              ))}
            </div>
          </div>
          <div>
        ...
        <div className={styles.footerBottom}>
          ...
          <div className={styles.socialIcons}>iDEAL · Apple Pay · Google Pay · PayPal · Creditcard</div>
        </div>
      </footer>
    </div>
  );
