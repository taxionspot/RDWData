...
import { buildScoreResult as _buildScoreResult } from "@/lib/vehicle/score";
...
// buildScoreResult is now a pure function in lib/vehicle/score.ts; alias it here
// so the useMemo call below keeps its exact shape (no behavior change).
const buildScoreResult = _buildScoreResult;
